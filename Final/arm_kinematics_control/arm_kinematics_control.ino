...
Adafruit_PWMServoDriver pwm = Adafruit_PWMServoDriver(0x48);
...
ServoCal SERVO_CAL[6] = {
  ...
  /* CH_SHLDR */ {102, 512,  -90, 120, true,  0.0},  // invert: servo mounted mirrored vs kinematic +angle
  /* CH_ELBOW */ {102, 512, -130, 130, true,  0.0},  // invert: same — flips travel direction only,
  /* CH_WRIST */ {102, 512, -120, 120, false, 0.0},  //   the FK/IK math above is untouched and stays correct
